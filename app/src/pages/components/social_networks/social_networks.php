<div class="rmbt-social-networks" <?php echo ! empty($args['data']) ? $args['data'] : '' ?>>
    ...
    if (isset($rmbt_theme_options['rmbt-social-networks-icon_1'])
		...
		<a href="<?php echo ! empty($rmbt_theme_options['rmbt-social-networks-link_1'])
            ? esc_url($rmbt_theme_options['rmbt-social-networks-link_1'])
            : '#' ?>">
			<img src="<?php echo esc_url($rmbt_theme_options['rmbt-social-networks-icon_1']['url']) ?>" alt="<?php echo ! empty($rmbt_theme_options['rmbt-social-networks-icon_1_alt'])
	...
	if (isset($rmbt_theme_options['rmbt-social-networks-icon_2'])
		...
		<a href="<?php echo ! empty($rmbt_theme_options['rmbt-social-networks-link_2'])
	        ? esc_url($rmbt_theme_options['rmbt-social-networks-link_2'])
	        : '#' ?>">
			<img src="<?php echo esc_url($rmbt_theme_options['rmbt-social-networks-icon_2']['url']) ?>" alt="<?php echo ! empty($rmbt_theme_options['rmbt-social-networks-icon_2_alt'])
	...
	if (isset($rmbt_theme_options['rmbt-social-networks-icon_3'])
		...
		<a href="<?php echo ! empty($rmbt_theme_options['rmbt-social-networks-link_3'])
	        ? esc_url($rmbt_theme_options['rmbt-social-networks-link_3'])
	        : '#' ?>">
			<img src="<?php echo esc_url($rmbt_theme_options['rmbt-social-networks-icon_3']['url']) ?>" alt="<?php echo ! empty($rmbt_theme_options['rmbt-social-networks-icon_3_alt'])
	...
	if (isset($rmbt_theme_options['rmbt-social-networks-icon_4'])
		...
		<a href="<?php echo ! empty($rmbt_theme_options['rmbt-social-networks-link_4'])
	        ? esc_url($rmbt_theme_options['rmbt-social-networks-link_4'])
	        : '#' ?>">
			<img src="<?php echo esc_url($rmbt_theme_options['rmbt-social-networks-icon_4']['url']) ?>" alt="<?php echo ! empty($rmbt_theme_options['rmbt-social-networks-icon_4_alt'])
