    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'subtitle' => esc_html__('Those numbers will be displayed in the top row of the header', RMBT_TEXT_DOMAIN_THEME),
                'description' => esc_html__('If multiple phone numbers are required, they should be separated by commas', RMBT_TEXT_DOMAIN_THEME),
            ),
            array(
                'id' => 'rmbt-manager-1-email',
                'type' => 'text',
                'title' => esc_html__('Add first manager email', RMBT_TEXT_DOMAIN_THEME),
                'subtitle' => esc_html__('Those emails will be displayed in the top row of the header', RMBT_TEXT_DOMAIN_THEME),
                'description' => esc_html__('If multiple emails are required, they should be separated by commas', RMBT_TEXT_DOMAIN_THEME),
            ),
