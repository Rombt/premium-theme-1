...
<div class="rmbt-full-width rmbt-how-we-work-full-width">
	...
	>
		<?php if ( $rmbt_theme_options['rmbt-how-we-work-card_section-title'] ) : ?>
			<h2 class='title-section'> <?php echo esc_html( rmbt_get_redux_field( 'rmbt-how-we-work-card_section-title', 1 ) ); ?> </h2>
		<?php endif ?>
		<?php if ( isset( $rmbt_theme_options['rmbt-how-we-work-card_section-subtitle'] ) && '' !== $rmbt_theme_options['rmbt-how-we-work-card_section-subtitle'] ) : ?>
			<p class='subtitle-section'>
				<?php echo esc_html( rmbt_get_redux_field( 'rmbt-how-we-work-card_section-subtitle', 1 ) ); ?>
			</p>
		<?php endif ?>
		...
		<div class="rmbt-how-we-work__row">
			<div class="rmbt-how-we-work__col shadow-box">
				<div class="wrap-img rmbt-how-we-work__img">
					...
					echo rmbt_redux_img( 'rmbt-how-we-work-card-1-img', 'rmbt-how-we-work-card-1-img-alt' );
					?>
				</div>
				<div>
			...
			<div class="rmbt-how-we-work__col shadow-box">
				<div class="wrap-img rmbt-how-we-work__img">
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo rmbt_redux_img( 'rmbt-how-we-work-card-2-img', 'rmbt-how-we-work-card-2-img-alt' );
					?>
				</div>
				<div>
			...
			<div class="rmbt-how-we-work__col shadow-box">
				<div class="wrap-img rmbt-how-we-work__img">
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo rmbt_redux_img( 'rmbt-how-we-work-card-3-img', 'rmbt-how-we-work-card-3-img-alt' );
					?>
				</div>
				<div>
			...
			<div class="rmbt-how-we-work__col shadow-box">
				<div class="wrap-img rmbt-how-we-work__img">
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo rmbt_redux_img( 'rmbt-how-we-work-card-4-img', 'rmbt-how-we-work-card-4-img-alt' );
					?>
				</div>
				<div>
