...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Social networks', RMBT_TEXT_DOMAIN_THEME ),
		'id' => 'settings_social-networks',
		'desc' => esc_html__( 'Settings Social networks', RMBT_TEXT_DOMAIN_THEME ),
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'The link of the first icon of the social networks block', RMBT_TEXT_DOMAIN_THEME ),
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'The link of the second icon of the social networks block', RMBT_TEXT_DOMAIN_THEME ),
			),
			...
			array(
				...
				'type' => 'text',
				'title' => esc_html__( 'The link of the third icon of the social networks block', RMBT_TEXT_DOMAIN_THEME ),
			),
