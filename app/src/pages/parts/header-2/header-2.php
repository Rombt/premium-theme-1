   ...
   <section class="rmbt-container rmbt-header-2-top-row">
      ...
      <div class="rmbt-header-2__row rmbt-header-2-top-row">
         ...
         <div class="rmbt-header-2__col rmbt-header-2-top-col-right">
            <!-- icons of search, languages, cart, login -->
            <a href="#rmbt-search_modal" class="rmbt-search-modal__trigger popup-link">
               <svg>
                  <use xlink:href="<?php echo get_template_directory_uri() ?>/assets/img/icons/sprite.svg#search_5_2">
                  </use>
               </svg>
            </a>
            <a href="#" class="">
               <svg>
                  <use xlink:href="<?php echo get_template_directory_uri() ?>/assets/img/icons/sprite.svg#cart_4_2">
                  </use>
               </svg>
            </a>
