		...
		<div class="rmbt-header-2__row rmbt-header-2-top-row">
			<div class="rmbt-header-2__col rmbt-header-2-top-col-left">
				<div class="rmbt-header-2-top-col-left__email">
					...
					echo get_icon_svg( 'email_1', true, 'rmbt-header-2-top-col-left__email-icon' );
					?>
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo rmbt_redux_repeater_to_ul( 'rmbt-managers_email', 'mailto', 'rmbt-managers-show', 'header' );
					?>
				...
				<div class="rmbt-header-2-top-col-left__phones">
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo get_icon_svg( 'phone_1', true, 'rmbt-header-2-top-col-left__phones-icon' );
					?>
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo rmbt_redux_repeater_to_ul( 'rmbt-managers_phone', 'tel', 'rmbt-managers-show', 'header' );
					?>
					<div class="ul-toggle-wrap">
						<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						echo get_icon_svg( 'triangle' );
			...
			<div class="rmbt-header-2__col rmbt-header-2-top-col-right">
				<a href="#rmbt-search_modal" class="rmbt-search-modal__trigger popup-link">
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo get_icon_svg( 'search' );
					?>
				</a>
				<a href="#" class="">
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo get_icon_svg( 'cart' );
					?>
				</a>
				<a href="#" class="">
					<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo get_icon_svg( 'login' );
					?>
				</a>
